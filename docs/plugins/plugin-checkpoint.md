...
| 字段 | 类型 | 默认值 | 说明 |
|---|---|---|---|
| `rootDir` | string | `'data:/checkpoints'` | 存储目录：存储 URI（默认 data:/checkpoints）。所有 checkpoint blob 和 manifest 写入此位置。 |
