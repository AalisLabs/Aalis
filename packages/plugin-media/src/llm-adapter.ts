...
export const DEFAULT_VISION_PROMPT =
  ...
  '对确有把握、特征足够明确的游戏/动画/角色/网络梗，可以直接点名；但只要没把握，就老实描述外观、UI、配色、' +
  '文字与画风，不要硬猜具体名字、更不要往热门作品上套——宁可说"看不出具体是什么"，也别硬认成 Minecraft/原神/' +
  '明日方舟之类（认错比模糊更糟）。\n\n' +
...
export const DEFAULT_VISION_DETAILED_PROMPT =
  ...
  '对确有把握的游戏/动画/角色/网络梗可点名识别，但没把握时只如实描述外观与文字、不要硬猜或往热门作品上套（认错比不点名更糟）；' +
...
export const DEFAULT_VISION_BATCH_PROMPT =
  ...
  '其次描述主体对象、人物动作、文字/表情包文案；画面中的游戏/动画/角色/网络梗仅在有把握时点名，' +
  '没把握就客观描述外观与文字、不硬套热门作品。' +
