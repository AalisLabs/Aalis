...
function buildExtractionPrompt(
  ...
  const system: Message = {
    ...
    content: [
      ...
      '- **event.title 命名规范（强制）**：title 必须能让不知道上下文的人一眼看出"谁对什么做了什么/发生了什么具体的事"，**禁止使用「关于…的讨论/互动/调侃/分享/感叹」等虚词套壳**——这类写法抹掉"主体"和"动作"，导致 consolidate 把截然不同的事件误判为候选、浪费大量 LLM 调用，且日后回忆时毫无辨识度。',
      '  · 正确格式：「[主要人物昵称缩写] + [具体动作] + [具体对象/结果]」；或「[具体对象] + [发生了什么]」。鼓励加时间锚点（「5月/周末/昨晚…」）区分同类事件。',
      '  · ❌「关于天气的讨论」→ ✅「X 等人吐槽高温天气」',
      '  · ❌「关于禁言功能的测试与讨论」→ ✅「管理员测试 QQ 群禁言功能」',
      '  · ❌「关于《三角洲》的讨论」→ ✅「残龙等人开黑《三角洲》」',
      '  · ❌「关于 Aalis 与 Alice 的互动调侃」→ ✅「群友调侃 Aalis 与 Alice 外貌差异」',
      '  · ❌「关于"复苏"的讨论与分享」→ ✅「Xilent 等分享《塔科夫》复苏模组连胜心得」',
      '  · 如确实无明确主要人物且是纯话题交流，至少写「[精确话题关键词]([时间锚])」，例如「高温天气吐槽(5月下旬)」——**title 里绝不能带裸"讨论"二字**。',
      '  · **category=discussion 是分类标签，不是 title 的写法授权**：即使 category=discussion，title 仍须按事实写"谁就什么做了什么/说了什么"。',
      '  · title 需 ≤30字，并尽量通过 eventEntityEdges part-of 把核心话题实体挂上，让事件可被检索。',
      '',
      '## 正确建模示例',
